# Weekly local report prompt for Claude

You are a **local classifier** running on my machine.

Your task is to classify this week's AI-assisted engineering work into a strict JSON report.
...
1. Estimate topic share across my AI-assisted work this week.
